...
public class BisiestosTest {
	...
	*/
	...
	//---> Cambio todos los esBisiesto por main para probar su Bisiestos
	//Test 1
	@Test
	public void testHappyPath(){
		year = 2000;
		assertTrue("Es bisiesto, fallo", true == bis.main(year));
	...
	public void testDivisibleBy100(){
		year = 700;
		assertTrue("No bisiesto, fallo", false == bis.main(year));
	...
	public void testDivisibleBy4And100(){
		year = 2200;
		assertTrue("No es bisiesto, fallo", false == bis.main(year));
		System.out.println(year + " no es bisiesto");
	}
}
